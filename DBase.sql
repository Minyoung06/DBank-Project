...
DROP TABLE IF EXISTS service.transaction;
...
CREATE TABLE service.transaction(
...
INSERT INTO service.transaction(send_account_id, receiver_account_id,amount, memo, timestamp)
...
SELECT * FROM user;
SELECT * FROM account;
SELECT * FROM service.transaction;
SELECT * FROM product;
